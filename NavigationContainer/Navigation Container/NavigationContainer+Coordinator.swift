...
class NavigationContainerCoordinator: ObservableObject {
	...
	func push<Destination: View>(animated: Bool = true, id: String? = nil, isRoot: Bool = false, to destination: @escaping () -> Destination) {
